...
import { WalletOnboardingGrantListener } from '../application/wallet/wallet-onboarding-grant.listener';
...
@Module({
  ...
  // WalletNotifier is exported so distribution can tell a vendor why a lead did or did not
  // reach them. The push belongs to the wallet; the recharge conversation that follows it is
  // an ordinary CreditRecharge turn (TDR §25.7).
  exports: [WalletService, WalletNotifier, PaymentProcessor, HANDLE_PAYMENT_NOTIFICATION],
})
